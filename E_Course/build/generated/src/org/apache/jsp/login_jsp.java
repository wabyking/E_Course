...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<body>\n");
      out.write("\n");
      out.write("<div id=\"dialog-form\" title=\"欢迎登陆\" style=\"margin-right: 40%;\">\n");
      out.write("\t<form id=\"loginform\" action=\"");
      out.print( request.getContextPath());
      out.write("/login/loginCheck\" method=\"post\">\n");
      out.write("            <div>\n");
      out.write("            <div>\n");
      out.write("\t\t<label type=\"text\">用户名</label>\n");
      out.write("                <input type=\"text\" size=\"20\" name=\"username\" id=\"username\" value=\"\" class=\"text ui-widget-content ui-corner-all\"/>\n");
      out.write("                <label></label>\n");
      out.write("        </div><br/><br/>\n");
      out.write("        <div>\n");
      out.write("            \n");
      out.write("\t\t<label for=\"password\" >密码</label>\n");
      out.write("                <input type=\"password\"  size=\"20\" name=\"password\" id=\"password\" value=\"\" class=\"text ui-widget-content ui-corner-all\" />\n");
      out.write("                <label></label>\n");
      out.write("        </div><br/>\n");
      out.write("        <div>\n");
      out.write("                <label for=\"randomCode\">验证码</label>\n");
      out.write("\t\t<input type=\"text\" size=\"4\"  name=\"randomCode\" id=\"randomCode\" value=\"\" class=\"text ui-widget-content ui-corner-all\" />\n");
      out.write("                <label></label>\n");
      out.write("        </div><br/>\n");
