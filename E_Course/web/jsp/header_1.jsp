        ...
        <div id="header" class="clear">
            <div id="topnav"  class="nav">
                <ul id="navul">
                    ...
                    <!--        class="active"-->
                    <li><a href="annouce.jsp">教学公告</a></li>
                    <li><a href="introduction.jsp">课程简介</a></li>
                    <li><a href="teacher.jsp">师资力量</a></li>
                    <li><a href="teach.jsp">教学内容</a></li>
                    <li><a href=<%= request.getContextPath()%>"material.jsp">教学资料</a></li>
                    <li><a href="apply.jsp">申报材料</a></li>
                    <li><a href="homework.jsp">作业管理</a></li>
